...
return new class extends Migration
{
    ...
    {
        DB::statement("ALTER TABLE loan MODIFY COLUMN status_persetujuan ENUM('menunggu','disetujui','ditolak','dibatalkan') NOT NULL DEFAULT 'menunggu'");
    ...
    {
        DB::statement("ALTER TABLE loan MODIFY COLUMN status_persetujuan ENUM('menunggu','disetujui','ditolak') NOT NULL DEFAULT 'menunggu'");
