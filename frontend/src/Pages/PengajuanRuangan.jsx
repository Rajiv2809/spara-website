...
const ruanganData = [
  ...
  { nama: "Lab Motion Capture", kode: "GT-L3-002", gedung: "Gedung Technopreneur", status: "TERSEDIA", lantai: "Lantai 3", kapasitas: 20, fasilitas: ["Kamera Motion Capture", "AC", "PC Workstation", "WiFi", "Green Screen"], deskripsi: "Lab khusus motion capture dengan peralatan profesional untuk penelitian dan produksi animasi 3D." },
  { nama: "Workspace Software Development", kode: "GT-L2-003", gedung: "Gedung Technopreneur", status: "TERSEDIA", lantai: "Lantai 2", kapasitas: 40, fasilitas: ["Proyektor", "AC", "Whiteboard", "WiFi", "32 PC"], deskripsi: "Ruang kerja pengembangan perangkat lunak dengan workstation berperforma tinggi dan koneksi internet dedicated." },
  { nama: "Cyber Physical System Security Lab", kode: "GT-L4-004", gedung: "Gedung Technopreneur", status: "MAINTENANCE", lantai: "Lantai 4", kapasitas: 25, fasilitas: ["Server Rack", "AC", "Whiteboard", "WiFi", "Firewall Hardware"], deskripsi: "Laboratorium keamanan sistem cyber-physical dengan perangkat penelitian keamanan siber mutakhir." },
  { nama: "Workspace Cyber Forensic", kode: "GT-L4-005", gedung: "Gedung Technopreneur", status: "TERSEDIA", lantai: "Lantai 4", kapasitas: 15, fasilitas: ["PC Forensik", "AC", "Whiteboard", "WiFi", "Write Blocker"], deskripsi: "Ruang kerja forensik digital dengan perangkat lunak dan keras khusus investigasi kejahatan siber." },
  { nama: "Lab Clay Modeling", kode: "GT-L1-006", gedung: "Gedung Technopreneur", status: "TERSEDIA", lantai: "Lantai 1", kapasitas: 20, fasilitas: ["Meja Kerja", "AC", "Rak Penyimpanan", "Wastafel", "Oven Keramik"], deskripsi: "Laboratorium pemodelan clay dengan fasilitas lengkap untuk desain produk dan eksplorasi seni kreatif." },
  { nama: "Workspace Remote Sensing", kode: "GT-L3-007", gedung: "Gedung Technopreneur", status: "TIDAK TERSEDIA", lantai: "Lantai 3", kapasitas: 30, fasilitas: ["Proyektor", "AC", "Whiteboard", "WiFi", "GPS Tools", "Drone"], deskripsi: "Ruang kerja penginderaan jauh dengan perangkat analisis data geospasial dan citra satelit." },
  ...
  { nama: "Mini Theatre", kode: "GU-L3-016", gedung: "Gedung Utama", status: "TIDAK TERSEDIA", lantai: "Lantai 3", kapasitas: 80, fasilitas: ["Proyektor 4K", "Sound System", "AC", "Kursi Theatre", "Lighting", "Layar Lebar"], deskripsi: "Mini teater berkapasitas 80 orang dengan sistem audio-visual profesional untuk pemutaran film dan presentasi." },
  { nama: "Aula Serbaguna", kode: "GU-L1-017", gedung: "Gedung Utama", status: "TERSEDIA", lantai: "Lantai 1", kapasitas: 150, fasilitas: ["Stage", "Sound System", "AC", "Kursi Lipat", "Podium", "Proyektor Ganda"], deskripsi: "Aula berkapasitas besar yang dapat digunakan untuk seminar, wisuda, dan berbagai acara resmi kampus." },
  { nama: "Ruang Seminar A", kode: "GU-L3-018", gedung: "Gedung Utama", status: "TERSEDIA", lantai: "Lantai 3", kapasitas: 60, fasilitas: ["Proyektor Ganda", "AC", "Sound System", "Kursi Seminar", "WiFi", "Podium"], deskripsi: "Ruang seminar representatif dengan dua proyektor dan sistem suara berkualitas tinggi untuk acara akademik." },
  { nama: "Lab Komputer Terapan", kode: "GU-L2-019", gedung: "Gedung Utama", status: "TERSEDIA", lantai: "Lantai 2", kapasitas: 45, fasilitas: ["45 PC", "Proyektor", "AC", "Printer", "WiFi", "Scanner"], deskripsi: "Lab komputer lengkap dengan 45 unit PC berperforma tinggi untuk praktikum pemrograman dan pengolahan data." },
  { nama: "Ruang Rapat Eksekutif", kode: "GU-L4-020", gedung: "Gedung Utama", status: "TERSEDIA", lantai: "Lantai 4", kapasitas: 12, fasilitas: ["TV Conference", "AC", "Meja Oval", "WiFi", "Teleconference System", "Mini Bar"], deskripsi: "Ruang rapat premium untuk pertemuan pimpinan dan tamu VIP dengan fasilitas konferensi video terkini." },
  { nama: "Co-Working Space Premium", kode: "GU-L1-021", gedung: "Gedung Utama", status: "TERSEDIA", lantai: "Lantai 1", kapasitas: 60, fasilitas: ["Meja Panjang", "AC", "WiFi Cepat", "Sofa", "Colokan Banyak", "Loker", "Pantry"], deskripsi: "Area kerja bersama premium dengan suasana modern, cocok untuk pekerjaan individual maupun kolaborasi tim besar." },
  { nama: "Ruang Diskusi Terbuka", kode: "GU-L3-022", gedung: "Gedung Utama", status: "TIDAK TERSEDIA", lantai: "Lantai 3", kapasitas: 16, fasilitas: ["TV LED", "Whiteboard", "AC", "WiFi", "Bean Bag"], deskripsi: "Ruang diskusi santai dengan konsep terbuka dan furnitur fleksibel, cocok untuk brainstorming informal." },
  { nama: "Laboratorium Bahasa", kode: "GU-L4-023", gedung: "Gedung Utama", status: "TERSEDIA", lantai: "Lantai 4", kapasitas: 36, fasilitas: ["Headset Audio", "PC", "AC", "Proyektor", "WiFi", "Bilik Rekam"], deskripsi: "Lab bahasa modern dengan bilik rekaman individual dan sistem audio terpusat untuk pembelajaran bahasa asing." },
  { nama: "Studio Foto & Video", kode: "GU-L2-024", gedung: "Gedung Utama", status: "TERSEDIA", lantai: "Lantai 2", kapasitas: 15, fasilitas: ["Lighting Studio", "Green Screen", "Kamera Mirrorless", "AC", "Backdrop", "Reflector"], deskripsi: "Studio foto dan video profesional dengan pencahayaan lengkap untuk produksi konten visual berkualitas tinggi." },
  { nama: "Ruang Seminar B", kode: "GU-L4-025", gedung: "Gedung Utama", status: "MAINTENANCE", lantai: "Lantai 4", kapasitas: 55, fasilitas: ["Proyektor", "AC", "Sound System", "Kursi Seminar", "WiFi", "Whiteboard Digital"], deskripsi: "Ruang seminar berkapasitas menengah dengan whiteboard digital interaktif dan sistem tata suara modern." },
  { nama: "Workspace Data Science", kode: "GB-L1-026", gedung: "Gedung Baru", status: "TERSEDIA", lantai: "Lantai 1", kapasitas: 32, fasilitas: ["PC High-End", "AC", "Proyektor", "WiFi", "Server Lokal", "Whiteboard"], deskripsi: "Ruang kerja data science dengan workstation berperforma tinggi dan akses server lokal untuk komputasi intensif." },
  { nama: "Lab Robotika", kode: "GB-L2-027", gedung: "Gedung Baru", status: "TERSEDIA", lantai: "Lantai 2", kapasitas: 24, fasilitas: ["Robot Kit", "AC", "Meja Kerja Luas", "WiFi", "Proyektor", "3D Printer"], deskripsi: "Laboratorium robotika lengkap dengan berbagai kit robot dan printer 3D untuk prototyping dan penelitian." },
  { nama: "Ruang Presentasi Interaktif", kode: "GB-L1-028", gedung: "Gedung Baru", status: "TERSEDIA", lantai: "Lantai 1", kapasitas: 42, fasilitas: ["Layar Sentuh Besar", "AC", "Sound System", "WiFi", "Kursi Lipat", "Podium Digital"], deskripsi: "Ruang presentasi modern dengan layar sentuh interaktif berukuran besar untuk sesi pembelajaran dan pitching." },
  { nama: "Lab Kecerdasan Buatan", kode: "GB-L3-029", gedung: "Gedung Baru", status: "TIDAK TERSEDIA", lantai: "Lantai 3", kapasitas: 20, fasilitas: ["GPU Workstation", "AC", "Proyektor", "WiFi", "Whiteboard", "Server GPU"], deskripsi: "Lab AI dengan workstation GPU untuk pelatihan model machine learning dan deep learning skala besar." },
  { nama: "Ruang Kolaborasi Kreatif", kode: "GB-L2-030", gedung: "Gedung Baru", status: "TERSEDIA", lantai: "Lantai 2", kapasitas: 38, fasilitas: ["Meja Modular", "AC", "TV LED Ganda", "WiFi", "Whiteboard Magnetik", "Proyektor"], deskripsi: "Ruang kolaborasi fleksibel dengan furnitur modular yang dapat dikonfigurasi sesuai kebutuhan tim kreatif." },
  { nama: "Studio Musik Digital", kode: "GB-L1-031", gedung: "Gedung Baru", status: "TERSEDIA", lantai: "Lantai 1", kapasitas: 10, fasilitas: ["DAW Workstation", "MIDI Controller", "AC", "Kedap Suara", "Monitor Speaker", "Synthesizer"], deskripsi: "Studio musik digital profesional dengan perangkat audio terlengkap untuk produksi musik dan sound design." },
  { nama: "Lab Bioinformatika", kode: "GB-L3-032", gedung: "Gedung Baru", status: "MAINTENANCE", lantai: "Lantai 3", kapasitas: 26, fasilitas: ["PC Workstation", "AC", "Proyektor", "WiFi", "Server Bioinformatika", "Whiteboard"], deskripsi: "Laboratorium bioinformatika dengan infrastruktur komputasi untuk analisis data genomik dan penelitian hayati digital." },
  { nama: "Ruang Workshop Desain", kode: "GB-L2-033", gedung: "Gedung Baru", status: "TERSEDIA", lantai: "Lantai 2", kapasitas: 30, fasilitas: ["Drawing Tablet", "AC", "Proyektor", "WiFi", "Meja Gambar", "Printer A3"], deskripsi: "Workshop desain grafis dan UI/UX dengan tablet digital dan printer format besar untuk produksi materi visual." },
  { nama: "Ruang Mediasi & Negosiasi", kode: "GB-L4-034", gedung: "Gedung Baru", status: "TERSEDIA", lantai: "Lantai 4", kapasitas: 14, fasilitas: ["AC", "Meja Oval", "WiFi", "TV Conference", "Whiteboard", "Kamera PTZ"], deskripsi: "Ruang formal untuk mediasi, negosiasi, dan rapat penting dengan fasilitas rekam dan konferensi video." },
  { nama: "Lab Jaringan Komputer", kode: "GB-L1-035", gedung: "Gedung Baru", status: "TIDAK TERSEDIA", lantai: "Lantai 1", kapasitas: 30, fasilitas: ["Rack Switch", "AC", "PC", "WiFi", "Kabel Patch", "Network Analyzer"], deskripsi: "Laboratorium jaringan komputer dengan perangkat Cisco dan infrastruktur simulasi jaringan skala enterprise." },
  { nama: "Ruang Pelatihan SDM", kode: "GB-L4-036", gedung: "Gedung Baru", status: "TERSEDIA", lantai: "Lantai 4", kapasitas: 48, fasilitas: ["Proyektor", "AC", "Kursi Pelatihan", "WiFi", "Sound System", "Whiteboard"], deskripsi: "Ruang pelatihan berkapasitas besar untuk kegiatan pengembangan sumber daya manusia dan training internal." },
  { nama: "Studio Desain Produk", kode: "GB-L3-037", gedung: "Gedung Baru", status: "TERSEDIA", lantai: "Lantai 3", kapasitas: 22, fasilitas: ["3D Printer", "Laser Cutter", "AC", "Meja Kerja", "WiFi", "Proyektor"], deskripsi: "Studio desain produk dengan fasilitas fabrikasi digital termasuk 3D printer dan laser cutter untuk prototyping." },
  { nama: "Ruang Seminar C", kode: "GB-L2-038", gedung: "Gedung Baru", status: "MAINTENANCE", lantai: "Lantai 2", kapasitas: 70, fasilitas: ["Proyektor Ganda", "AC", "Sound System", "Kursi Seminar", "WiFi", "Panggung Mini"], deskripsi: "Ruang seminar besar dengan panggung mini dan sistem audio-visual profesional untuk acara akademik dan industri." },
  { nama: "Lab Keamanan Jaringan", kode: "GB-L3-039", gedung: "Gedung Baru", status: "TERSEDIA", lantai: "Lantai 3", kapasitas: 18, fasilitas: ["PC Penetration Testing", "AC", "WiFi Isolated", "Whiteboard", "Server Honeypot"], deskripsi: "Lab keamanan jaringan dengan environment terisolasi untuk praktikum ethical hacking dan penetration testing." },
  { nama: "Ruang Konferensi Internasional", kode: "GB-L4-040", gedung: "Gedung Baru", status: "TERSEDIA", lantai: "Lantai 4", kapasitas: 100, fasilitas: ["Layar LED Besar", "Sound System Premium", "AC", "Kursi Konferensi", "WiFi", "Simultaneous Interpreter Booth"], deskripsi: "Ruang konferensi internasional berkapasitas besar dengan fasilitas interpretasi simultan dan sistem AV premium." },
];
...
const ModalDetail = ({ ruangan, onClose }) => {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50" onClick={onClose}>
      <div className="bg-white rounded-2xl overflow-hidden w-[380px] max-w-[90vw] shadow-2xl" onClick={(e) => e.stopPropagation()}>
        <div className="bg-[#3D0C1F] p-4 flex items-start justify-between">
          <div>
            <h2 className="text-white font-bold text-[15px] leading-snug max-w-[270px]">{ruangan.nama}</h2>
            <p className="text-pink-300 text-[11px] mt-0.5">Kode: {ruangan.kode}</p>
          </div>
        ...
        <div className="relative h-[100px] bg-gradient-to-br from-sky-300 to-blue-500 flex items-end justify-center pb-2 overflow-hidden">
          <div className="absolute inset-0 flex items-end justify-center pb-2">
            <div className="flex items-end gap-1.5">
              <div className="w-6 h-10 bg-white/25 rounded-t-sm" />
              <div className="w-10 h-16 bg-white/35 rounded-t-sm" />
              <div className="w-8 h-13 bg-white/30 rounded-t-sm" />
              <div className="w-6 h-9 bg-white/25 rounded-t-sm" />
              <div className="w-4 h-7 bg-white/20 rounded-t-sm" />
            </div>
          </div>
        </div>
...
const GedungCard = ({ ruangan, onDetail }) => {
  ...
  return (
    <div className="bg-white rounded-2xl overflow-hidden border border-pink-100 shadow-[0_6px_20px_rgba(0,0,0,0.07)] flex flex-col hover:scale-[1.02] hover:shadow-xl transition duration-300">
      <div className="relative h-[120px] bg-gradient-to-br from-sky-300 to-blue-500 overflow-hidden">
        <div className="absolute inset-0 flex items-end justify-center pb-3">
          <div className="flex items-end gap-1.5">
            <div className="w-5 h-10 bg-white/25 rounded-t-sm" />
            <div className="w-8 h-16 bg-white/35 rounded-t-sm" />
            <div className="w-12 h-20 bg-white/40 rounded-t-sm" />
            <div className="w-8 h-14 bg-white/35 rounded-t-sm" />
            <div className="w-5 h-9 bg-white/25 rounded-t-sm" />
          </div>
        </div>
