...
// ── Ganti sesuai instance axiosClient yang dipakai di project ──
...
export default function Laporan() {
    ...
    const fetchData = useCallback(() => {
        ...
        if (filter === 'seminggu' || filter === 'sebulan') {
            ...
            // filter custom = tepat satu hari (tanpa parameter "filter")
        ...
        <div className="bg-gradient-to-b from-[#FFF6F1] to-[#FFD1D1] min-h-screen">
            ...
            <div className="lg:ml-[300px] flex-1 lg:p-10 p-4">
                ...
                <div className="flex flex-wrap gap-2 items-center mb-4">
                    ...
                    {/* Tanggal: acuan untuk seminggu/sebulan, atau filter hari untuk custom */}
                    <input
                        type="date"
                        value={tanggal}
