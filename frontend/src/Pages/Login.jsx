...
export default function LoginPage() {
  ...
  return (
    <div className="login-container  flex items-center justify-center bg-gradient-to-b from-[#DC4C75] to-[#862440] h-screen overflow-hidden relative">
      <img src={wave1} alt="Wave 1" className="size-[800px] max-h-[800px] absolute bottom-0 left-0 " />
      <img src={wave2} alt="Wave 2" className="size-[800px] max-h-[800px] absolute top-0 right-0 " />
      ...
      <div className="card-login rounded-[44px] h-[500px] bg-white min-w-[900px] z-10 grid grid-cols-5">
        ...
        <div className="form-login col-span-3 flex flex-col items-center relative top-[50px] gap-[40px] px-[80px]">
          ...
          <div className="w-full relative ">
            ...
            <input
              ...
              className="w-full pl-12 pr-4 py-2 border-b-3 border-[#862440] focus:outline-none"
            />
          </div>
          ...
          <div className="w-full relative">
            ...
            <input
              ...
              className="w-full pl-12 pr-4 py-3 border-b-3 border-[#862440] focus:outline-none"
            />
          </div>
          <button
